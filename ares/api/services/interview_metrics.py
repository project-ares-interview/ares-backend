...
class InterviewMetrics:
    def __init__(self):
        ...
        self.nod_threshold = 8  # 끄덕임 감지 각도 임계값 (15~25도 권장)
        self.shake_threshold = 8  # 좌우 흔들기 감지 각도 임계값 (20~35도 권장)
        self.nod_cooldown = 0.8  # 끄덕임 감지 후 대기시간(초) (0.5~2.0 권장)
        self.shake_cooldown = 0.8  # 흔들기 감지 후 대기시간(초) (0.5~2.0 권장)
        self.head_min_frames = 4  # 머리 움직임 판단 최소 프레임 수 (5~15 권장)
        self.nod_pattern_frames = 3  # 끄덕임 패턴 분석 프레임 수 (3~6 권장)
