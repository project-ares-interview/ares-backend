...
""",
    ...
    def post(self, request, *args, **kwargs):
        ...
        if fsm.get("followup_idx", 0) == 0:
            stage_map = {"아이스브레이킹": "icebreak", "자기소개": "intro:self", "지원 동기": "intro:motivation"}
            if current_stage in stage_map:
                ...
                if soft_fu: followups.append(soft_fu)
            ...
            if not followups:
                ...
                if isinstance(fu_list, list): followups.extend(fu_list)
